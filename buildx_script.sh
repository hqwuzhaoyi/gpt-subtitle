...
# docker build -t gpt-subtitle-web -f ./apps/web/Dockerfile --build-arg NEXT_PUBLIC_API_URL=http://192.168.2.23:3001 --build-arg API_URL=http://192.168.2.23:3001 .
...
docker buildx build --platform linux/amd64,linux/arm64 -t $API_IMAGE_NAME -f ./apps/web/Dockerfile --build-arg NEXT_PUBLIC_API_URL=http://localhost:3001 --build-arg API_URL=http://localhost:3001 --push .
